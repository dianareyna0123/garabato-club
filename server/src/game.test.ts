...
describe('puntuación',()=>{
  it('premia rapidez dentro de la posición',()=>{expect(scoreGuess(1,80000,80000)).toBe(500);expect(scoreGuess(1,0,80000)).toBe(400);expect(scoreGuess(1,40000,80000)).toBe(450);});
